...
$reqLike = "select l.id, l.id_utilisateur, l.id_element, u.nom as nom, u.prenom as prenom from `like` l inner join utilisateur u on l.id_utilisateur = u.id where id_element=".$row['idE'].";";
...
<form name='like' method='post' action="./controleurs/likeP.php">
...
?>
<form name='commentaire' method='post' action='./controleurs/commentaireP.php'> 
          <table align='center'>
            <tr>
              <td><input type='textarea' class="champForm" name='texte' id='texte' maxlength="300" /></td>
              <td><input type="hidden"  name="idElem"  value="<?php echo $row['idE']; ?>"></td>
            </tr>
            <tr>
                <td>
